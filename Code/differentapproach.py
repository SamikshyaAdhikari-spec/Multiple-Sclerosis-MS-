...
annotation_base_dir = "C:/Users/samik/Desktop/d"
...
for patient_id in range(1, num_patients + 1):
    ...
    overlay_path = os.path.join(base_dir, patient_folder, "Overlayed")  # Annotated images
    ...
    for slice_filename in slice_filenames:
        ...
        output_dir0 = os.path.join(annotation_base_dir, f"pat{patient_id}_{slice_id}_annotated", "0")
        output_dir1 = os.path.join(annotation_base_dir, f"pat{patient_id}_{slice_id}_annotated", "1")
        ...
        for y in range(0, image_height - window_height + 1, stride_y):
            for x in range(0, image_width - window_width + 1, stride_x):
                ...
                overlay_patch = overlayed_image[y:y + window_height, x:x + window_width]  # Extract corresponding overlayed patch
                ...
                # Save patch from Overlayed image (not Flair-seg)
