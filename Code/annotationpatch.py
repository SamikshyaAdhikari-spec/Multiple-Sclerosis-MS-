...
annotated_image_path = "C:/Users/samik/Documents/GitHub/MS-disease/Patient-42/slice_12new.jpg"  # Replace with the actual image path
...
image = cv2.resize(image, (annotated_image.shape[1], annotated_image.shape[0]))
...
output_dir0 = "C:/Users/samik/Desktop/annotation/pat42_slice_12_annoted/0"
output_dir1 = "C:/Users/samik/Desktop/annotation/pat42_slice_12_annoted/1"
...
for y in range(0, image_height - window_height + 1, stride_y):
    for x in range(0, image_width - window_width + 1, stride_x):
        ...
        annotated_patch = annotated_image[y:y + window_height, x:x + window_width]
        ...
        cv2.imwrite(patch_path, annotated_patch)
